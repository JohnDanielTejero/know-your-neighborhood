            ...
            <Layout>
                 <div id = "contact-us">
                    <div className ="container py-5">
                        <h1 className = "text-center fw-bold display-5" style={{color: "#d1a080"}}>
                            Let's Talk
                        </h1>
                        ...
                        <div className ="mt-5 px-2">
                            <form className = "row gy-3 px-3 pt-3 pb-5 border rounded-3 shadow-lg" style={{backgroundColor : "rgba(228, 194, 193, 0.2)"}}>
                        ...
                        <div className ="w-100 mt-5">
                            <div className = "d-flex flex-column h5 fw-normal">
                                <div className ="d-inline">
                                    <span className ="bi bi-geo-alt-fill" style={{color : "#d1a080"}}>
                                        <span className ="ms-1" style={{color : "#d1a080"}}>
                                            Mileguas, Makati, Philippines
                                        </span>
                                    </span>
                                </div>
                                <div className ="d-inline">
                                    <span className ="bi bi-envelope" style={{color : "#d1a080"}}>
                                        <span className ="ms-1" style={{color : "#d1a080"}}>
                                            info.kyn@gmail.com
                                        </span>
                                    </span>
                                ...
                                <div className ="d-inline">
                                    <span className ="bi bi-telephone-fill" style={{color : "#d1a080"}}>
                                        <span className ="ms-1" style={{color : "#d1a080"}}>
                                            +63-929-555-6296
                                        </span>
                                    </span>
