                ...
                <div className="d-flex justify-content-center p-5">
                    <div className="card p-5 shadow-lg" style={{width: "40rem"}}>
                        <div className="card-header bg-transparent border-0">
                            <h1 className="display-6 fw-bold text-center" style={{color:"#d1a080"}}>Sign In</h1>
                            <span className = "text-muted text-center d-block">New to the platform?
                                <Link to = "/registration" className ="fw-bold form-links" style = {{textDecoration : "none !important", color: "#d1a080"}}> Register</Link>
                            </span>
                        </div>
